...
__global__ void reduceNeighbored(float *d_out, float *d_in, int n)
{
    //set thread ID
...
int main(int argc, char **argv)
{
    ...
    printf("Running global reduce average time elapsed: %f\n", elapsedTime);
    //    break;
    //case 1:
